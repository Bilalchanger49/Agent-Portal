                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <div class="header-info">
                                        <span class="text-black">Ehsan Ali</span>
                                        <p class="fs-12 mb-0">Money Transfer</p>
                                    </div>
                                    <img src="images/profile/profile.png" width="20" alt="/">
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="AppProfile.html" class="dropdown-item ai-icon">
                                    ...
                                    <a href="PageLogin.html" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                        <a class="has-arrow ai-icon" href="index.html" aria-expanded="false">
                ...
                <div class="form-head d-md-flex mb-sm-4 mb-3 col-md-12 align-items-start">
                    <div class="col-md-10">
                        <div class="me-auto d-lg-block d-block">
                            ...
                            <p class="mb-0">Welcome to Arman Exchange</p>
                        </div>
                    </div>
                    <div class="col-md-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-5 col-xl-5 col-md-5">
                                <div class="send-money">
                                    ...
                                    <form action="#" class="cal-pd">
                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                            <div class="form-group mt-4" style="width: 77vh;">
                                                <label>You Send</label>
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control w-100" placeholder="100.00" value="1000">
                                                    </div>
                                                    <div class="right-side col-md-4">
                                                        <label class="inputt-group-text input-group-text-count-flags" for="country_from">
                                                            <img class="country_flag_icon" id="receiving_flag" src="images/United.png">
                                                        </label>
                                            ...
                                            <div class="form-group mt-4" style="width: 77vh;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8 col-lg-8 col-xl-8">
                                                        <input type="text" class="form-control w-100" placeholder="1000.00" value="250,00.00">
                                                    </div>
                                                    <div class="right-side col-md-4 col-xl-4 col-xl-4">
                                                        <label class="inputt-group-text input-group-text-count-flags" for="country_from">
                                                            <img class="country_flag_icon" id="receiving_flag" src="/images/pakistan.png">
                                                        </label>
                                                        <select class="nice-select">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-xl-4 col-xxl-6 col-md-6">
                                                <div class="form-check custom-checkbox mb-3 checkbox-success">
                                                    ...
                                                    <label class="form-check-label" for="customCheckBox3">Cash</label>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-xxl-6 col-md-6">
                                                <div class="form-check custom-checkbox mb-3 checkbox-success">
                                                    <input type="checkbox" class="form-check-input"  id="customCheckBox3" required="">
                                                    <label class="form-check-label" for="customCheckBox3">Bank</label>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-xxl-6 col-md-6">
                                                <div class="form-check custom-checkbox mb-3 checkbox-success">
                                                    <input type="checkbox" class="form-check-input" id="customCheckBox3" required="">
                                                    <label class="form-check-label" for="customCheckBox3">Wallet</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                        ...
                                        <div class="calculation mt-3">
                                            <div class="row mt-1">
                                                <div class="col-xl-4 col-xxl-6 col-md-6">
                                                    <label class="form-check-label" for="customCheckBox3">Today Rate</label>
                                                </div>
                                                <div class="col-xl-4 col-xxl-6 col-md-6">
                                                    <label class="form-check-label" for="customCheckBox3" style="float: inline-end;">1 <span class="spn-fnt">GBP</span>=352.15 <apan class="spn-fnt">PKR</apan></label>
                                                </div><br>
                                                <div class="col-xl-4 col-xxl-6 col-md-6">
                                                    <label class="form-check-label" for="customCheckBox3">Transfer Fee</label>
                                                </div>
                                                <div class="col-xl-4 col-xxl-6 col-md-6">
                                                    <label class="form-check-label" for="customCheckBox3" style="float: inline-end;">GBP <span class="spn-fnt">2.99</span></label>
                                                </div><br>
                                                <div class="col-xl-4 col-xxl-6 col-md-6">
                                                    <label class="form-check-label" for="customCheckBox3">Payable Amount</label>
                                                </div>
                                                <div class="col-xl-4 col-xxl-6 col-md-6">
                                                    <label class="form-check-label" for="customCheckBox3" style="float: inline-end;">GBP <span class="spn-fnt">102.99</span></label>
                                                </div>
                                            </div>
                                        </div>
